...
Так как это LFI, можно попытаться постаивить в параметр слово "admin". Но у нас ничего не выйдет, поэтому попытаемся сделать самый легкий вариант LFI'я, это ставить "../"
# 
# 
### `PHP - Serialization`
