...
#
### `SIP - authentication`
Максимально легкое задание. Здесь нам нужно посмотреть на конец строк. И там будет либо пароль. Как в первой строке. Либо хэщ. Наша цель - это пароль, значит копируем цифры и вообщем-то все. На самом деле я дольше сидела над этим заданием, так как мне казалось странным такое быстрое решение
