...
Название задания говорит нам о том, что это шаблонная инъекция или же template injection. Мы видим форму и сразу понимаем что нужно сделать что-то с ней. Ищем разные пэйлоады.
