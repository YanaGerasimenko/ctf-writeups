...
-
А вот и наш токен. Попробуем проделать с ним те же операции что с предыдущим заданием. И у нас нчиего не выйдет. А все потому, что нужно узнать секрет. Задача уже труднее, но мы можем воспользоваться тулзой, как: jwtcrack, jwttool или даже John The Ripper.
# 
# 
##
## 
