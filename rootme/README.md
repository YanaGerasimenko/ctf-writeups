...
#
###`CISCO - password`
В данном задании мы получаем txt'шник, в котором видим ряд различных данных. Но давайте не забывать про название таска ведь оно всегда дает нам хинт. Обратимся к txt повнимательней.
#
#
### `DNS - zone transfert`
