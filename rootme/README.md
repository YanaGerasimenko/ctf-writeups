...
# 
### `FTP - authentication`
Мы работаем с файлов .pcap, а это означате что мы можем открыть его в Wireshark. По условию нам нужно работать с FTP и найти пароль. Так что находим самый первый пакет FTP и наживаем TCP-stream.
